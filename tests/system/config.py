...
class TestConfig:
    ...
    # Service URLs
    api_gateway_url: str = field(default_factory=lambda: os.getenv("API_GATEWAY_URL", "http://localhost:8080"))
    ai_pipeline_url: str = field(default_factory=lambda: os.getenv("AI_PIPELINE_URL", "http://localhost:8000"))
    ...
    github_webhook_secret: str = field(default_factory=lambda: os.getenv("GITHUB_WEBHOOK_SECRET", "test_secret"))
    test_repo: str = field(default_factory=lambda: os.getenv("TEST_REPO", "tagz97/ai-pr-reviewer"))
    ...
    # Test behavior
    skip_ai_tests: bool = field(default_factory=lambda: os.getenv("SKIP_AI_TESTS", "false").lower() == "true")
    use_mocks: bool = field(default_factory=lambda: os.getenv("USE_MOCKS", "false").lower() == "true")
